...
- Lake: `pages/destinations/lakes/<lake-slug>.html` (lakes.jst skeleton: googleMap, destinations, fishingReferences, notes, ONE bare backToGallery — no attributes) + `media/data/destinations/lakes/<lake-slug>/<lake-slug>.json`.
